...
class PotentialManager:
    ...
    def __init__(self, 
        ...
        self.external_scale = 1.0  # 外部门控统一缩放 guiding potentials 强度
    ...
    def set_external_scale(self, s: float):
        self.external_scale = float(s)
    ...
    def get_guide_scale(self, t):
        ...
        base = implemented_decay_types[self.guide_decay](t)
        return self.external_scale * base
